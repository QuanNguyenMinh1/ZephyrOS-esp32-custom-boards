...
procpu_ext_ram_org = (1065353216);
procpu_ext_ram_len = (4194304);
...
MEMORY
{
  ...
  rtc_slow_seg(RW): org = rtc_slow_org, len = rtc_slow_len - 24
  rtc_data_seg(RW): org = rtc_data_org, len = rtc_data_len
  rtc_slow_reserved_seg(RW): org = rtc_slow_org + rtc_slow_len - 24,
                             len = 24
...
ASSERT(((_ext_ram_end - _ext_ram_start) <= 8388608),
